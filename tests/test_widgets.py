...
async def test_network_panel_limits_events() -> None:
    ...
    # Force a small maxlen for testing
...
def test_command_highlighter_logic(registry: CommandRegistry) -> None:
    ...
    # Check if stylize was called (we check the internal _spans for simple verification)
...
async def test_console_panel_hint_updates(
    suggester: RokuSuggester, registry: CommandRegistry
) -> None:
